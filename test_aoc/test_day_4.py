...
one_card_many = ([41, 48, 83, 86, 17],[83, 86, 6, 31, 17, 9, 48, 53])
one_card_one = ([41, 48, 83, 86, 17],[83, 89, 6, 31, 10, 9, 99, 53])
one_card_none = ([41, 48, 83, 86, 17],[80, 84, 6, 31, 14, 9, 44, 54])
...
def test_input_cleaning(test_data):
